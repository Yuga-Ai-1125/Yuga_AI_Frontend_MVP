...
function MainApp() {
  ...
  // FOR MVP DEMO: Always set to false to bypass onboarding/authentication barriers
              ...
              <div className="flex items-center">
                <div className="flex-1">
                  <h2 className="text-2xl font-bold mb-2">
                    Write & Get Instant Feedback
                  </h2>
                  <p className="text-purple-100 mb-4">
                    Use our advanced OCR technology to scan your handwritten
                    solutions and receive immediate AI-powered feedback and
                    corrections.
                  </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  description: "Programming, Logic, Algorithms",
                  color: "indigo",
                  count: 75,
                },
                {
                  icon: Dna,
                  title: "Biology",
                  description: "Life Processes, Genetics",
                  color: "teal",
                  count: 65,
                },
              ].map((category, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      className={`px-4 py-2 bg-${category.color}-600 text-white rounded-lg hover:bg-${category.color}-700 transition-colors text-sm`}
                    >
                      Start Practice
                    </button>
                  </div>
        ...
        return (
          <div>
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Discover your ideal career path with personalized AI guidance
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl p-8 mb-8">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-indigo-100 text-lg mb-6">
                  ...
                  match your interests, skills, and personality.
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  description: "Research, Laboratory Work, Innovation",
                  color: "green",
                  careers: ["Research Scientist", "Lab Technician", "Professor"],
                },
                {
                  icon: Briefcase,
                ...
                },
                {
                  ...
                  color: "red",
                  careers: ["Doctor", "Nurse", "Therapist"],
                },
                {
                  icon: Languages,
                  title: "Education",
                  ...
                  color: "yellow",
                  careers: ["Teacher", "Professor", "Trainer"],
                },
                {
                  icon: Globe,
                  title: "Social Impact",
                  description: "NGO, Government, Public Service",
                  color: "teal",
                  careers: ["Social Worker", "Policy Maker", "Activist"],
                },
              ].map((category, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <button
                    className={`w-full mt-4 px-4 py-2 bg-${category.color}-600 text-white rounded-lg hover:bg-${category.color}-700 transition-colors`}
                  >
                    Explore Careers
                  </button>
                </div>
        ...
        return (
          <div>
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Earn certificates by completing courses and assessments
              </p>
            </div>
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600">
                            {index === 4 ? "Complete all courses" : "In Progress"}
                          </p>
                        </div>
                        <div className="text-right">
                          <div className="text-sm text-gray-500">
                            {Math.floor(Math.random() * 50) + 50}% Complete
                          </div>
        ...
        return (
          <div>
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Review and reinforce your learning with smart revision tools
              </p>
            </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Topics Revised</p>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-gray-600 mb-6">
                  Rapid-fire questions to reinforce key concepts
                </p>
                <div className="space-y-3">
                  {mockCourses.slice(0, 4).map((course) => (
                    <div
                    ...
                    >
                      <div className={`w-3 h-3 rounded mr-3 ${course.color}`} />
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="space-y-3">
                  {[
                    { topic: "Quadratic Equations", due: "Due now", urgent: true },
                    { topic: "Cell Division", due: "Due in 2 hours", urgent: false },
                    { topic: "Shakespeare Analysis", due: "Due tomorrow", urgent: false },
                    { topic: "Indian Constitution", due: "Due in 3 days", urgent: false },
                  ].map((item, index) => (
                    <div
                      key={index}

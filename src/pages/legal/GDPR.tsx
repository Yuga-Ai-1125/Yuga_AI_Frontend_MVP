...
import { Shield, Download, Trash2, Edit, Eye, UserCheck, FileText, Mail } from 'lucide-react';
...
export const GDPR: React.FC = () => {
  ...
  const dataCategories = [
    ...
    },
    {
      ...
      description: 'Course progress, quiz results, learning preferences, AI interactions',
      retention: '5 years for educational records',
      purpose: 'Personalized learning experience and progress tracking'
    },
    {
      category: 'Usage Analytics',
      description: 'Page views, feature usage, session duration, device information',
      retention: '2 years',
  ...
  const handleSubmitRequest = (e: React.FormEvent) => {
    e.preventDefault();
    alert('Your GDPR request has been submitted. We will respond within 30 days as required by law.');
    setFormData({
      name: '',
      email: '',
      requestDetails: '',
  ...
  return (
    ...
    >
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              We are committed to helping you exercise these rights in a transparent and efficient manner.
            </p>
          </div>
          
          <div className="prose prose-lg max-w-none text-gray-600">
            <p className="mb-4">
              The General Data Protection Regulation (GDPR) gives individuals in the European Union specific 
              rights regarding their personal data. YUGA AI is committed to protecting your privacy and 
              ensuring compliance with GDPR requirements.
            </p>
            <p>
              This page explains your rights under GDPR and provides tools to help you exercise them. 
              If you have any questions or need assistance, please don't hesitate to contact our Data Protection Officer.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {rights.map((right, index) => (
            <div key={index} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <p className="text-sm text-purple-600 font-medium">{right.action}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-12">
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Data We Collect and Process</h2>
          
          <div className="space-y-6">
            {dataCategories.map((data, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-bold text-gray-900 mb-3">{data.category}</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <h4 className="font-medium text-gray-900 mb-1">Data Types</h4>
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 mb-1">Retention Period</h4>
      ...
      <section className="mb-12">
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Submit a GDPR Request</h2>
            <p className="text-gray-600">
              Use this form to exercise your data protection rights. We will respond within 30 days.
            </p>
          </div>
          
          <form onSubmit={handleSubmitRequest} className="max-w-2xl mx-auto space-y-6">
            <div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-blue-800 text-sm">
                <strong>Note:</strong> To protect your privacy, we may need to verify your identity before processing your request. 
                This may involve additional verification steps depending on the nature of your request.
              </p>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-gray-200 rounded-lg p-4">
              <h3 className="font-bold text-gray-900 mb-2">Contract Performance</h3>
              <p className="text-gray-600 text-sm">
                Processing necessary for the performance of our contract with you (e.g., providing educational services)
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <p className="text-gray-600 text-sm">
                Processing for our legitimate interests (e.g., improving our services, fraud prevention)
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <p className="text-gray-600 text-sm">
                Processing based on your explicit consent (e.g., marketing communications, optional features)
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <p className="text-gray-600 text-sm">
                Processing required to comply with legal obligations (e.g., tax records, regulatory requirements)
              </p>
            </div>
          </div>
        </div>
      ...
      <section>
        <div className="bg-gradient-to-r from-purple-600 via-indigo-600 to-cyan-500 rounded-2xl p-8 md:p-12 text-white">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold mb-4">Contact Our Data Protection Officer</h2>
            <p className="text-xl text-purple-100 mb-8 max-w-3xl mx-auto">
              If you have questions about your data rights or need assistance with a GDPR request, 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <p className="text-purple-200">You may also contact your local data protection authority</p>
              </div>
            </div>
          </div>
        </div>

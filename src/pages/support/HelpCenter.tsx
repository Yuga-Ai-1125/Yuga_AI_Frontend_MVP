...
export const HelpCenter: React.FC = () => {
  ...
  const categories = [
    ...
    { id: 'getting-started', name: 'Getting Started', icon: <Star className="w-5 h-5" /> },
    { id: 'courses', name: 'Courses & Learning', icon: <Video className="w-5 h-5" /> },
    { id: 'ai-avatar', name: 'AI Avatar', icon: <MessageCircle className="w-5 h-5" /> },
    { id: 'account', name: 'Account & Billing', icon: <FileText className="w-5 h-5" /> }
  ];
  ...
  const articles = [
    {
      ...
      views: 15420,
      helpful: 98,
      excerpt: 'Learn the basics of navigating the platform and starting your first course.'
    },
    {
      id: 2,
      ...
      views: 12350,
      helpful: 95,
      excerpt: 'Discover how to effectively communicate with your AI tutor for better learning outcomes.'
    },
    {
      id: 3,
      ...
      views: 9870,
      helpful: 92,
      excerpt: 'Personalize your learning experience by setting preferences and goals.'
    },
    {
      id: 4,
      ...
      views: 8650,
      helpful: 89,
      excerpt: 'Everything you need to know about payments, upgrades, and cancellations.'
    },
    {
      id: 5,
    ...
    },
    {
      ...
      views: 6890,
      helpful: 94,
      excerpt: 'Get instant answers to your questions with our AI-powered doubt resolution system.'
    }
  ];
    ...
    >
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {quickActions.map((action, index) => (
            <div key={index} className="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow cursor-pointer">
      ...
      <section className="mb-12">
        <div className="bg-gradient-to-r from-purple-600 via-indigo-600 to-cyan-500 rounded-2xl p-8 md:p-12 text-white">
          <h2 className="text-3xl font-bold mb-6 text-center">Popular Topics</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white bg-opacity-10 rounded-lg p-4">
              <h3 className="font-bold mb-2">Course Navigation</h3>
              <p className="text-purple-100 text-sm">Learn how to navigate through courses and track your progress</p>
            </div>
            <div className="bg-white bg-opacity-10 rounded-lg p-4">
              <h3 className="font-bold mb-2">AI Avatar Features</h3>
              <p className="text-purple-100 text-sm">Discover all the capabilities of your AI learning companion</p>
            </div>
            <div className="bg-white bg-opacity-10 rounded-lg p-4">
              <h3 className="font-bold mb-2">Account Settings</h3>
              <p className="text-purple-100 text-sm">Manage your profile, preferences, and subscription settings</p>
            </div>
          </div>
        </div>
      </section>

  ...
  const faqs = [
    {
      ...
      answer: 'We aim to respond to all inquiries within 24 hours during business days. For urgent issues, please use our live chat feature.'
    },
    {
      question: 'What information should I include in my message?',
      answer: 'Please include your account email, a detailed description of your issue, and any relevant screenshots or error messages.'
    },
    {
      question: 'Do you offer phone support?',
      answer: 'Yes, phone support is available Monday through Friday, 9 AM to 6 PM PST. You can reach us at +1 (555) 123-4567.'
    }
  ];
          ...
          <div>
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg border border-purple-200">
              ...
              <p className="text-gray-600 mb-4">
                For urgent technical issues or account problems, use our live chat feature for instant assistance.
              </p>
        ...
        <div className="bg-gradient-to-r from-purple-600 via-indigo-600 to-cyan-500 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <p className="text-purple-200">Monday - Friday: 9 AM - 6 PM PST</p>
              <p className="text-purple-200">Saturday - Sunday: 10 AM - 4 PM PST</p>
            </div>
            <div>

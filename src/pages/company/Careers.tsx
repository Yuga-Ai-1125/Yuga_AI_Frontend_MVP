        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              learns. We're building the future of education, and we want you to
              help shape it.
            </p>
          </div>
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="mt-4 lg:mt-0 lg:ml-6">
                  <button
                    onClick={() =>
                      window.open(
                        `https://navodhan.com/apply/${job.id}`,
                        "_blank"
                      )
                    }
                    className="w-full lg:w-auto px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-lg hover:from-purple-700 hover:to-indigo-700 transition-all duration-200 font-medium"
                  >
                    Apply Now
                  </button>
                </div>
      ...
      <section>
        <div className="bg-gradient-to-r from-purple-600 via-indigo-600 to-cyan-500 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              className="px-8 py-3 bg-white text-purple-600 rounded-lg hover:bg-gray-100 transition-all duration-200 font-medium"
              onClick={() =>
                (window.location.href = "/contact/general-application")
              }
            >
              Send General Application
            </button>
            <button
              className="px-8 py-3 border-2 border-white text-white rounded-lg hover:bg-white hover:text-purple-600 transition-all duration-200 font-medium"
              onClick={() => (window.location.href = "/talent-network")}
            >

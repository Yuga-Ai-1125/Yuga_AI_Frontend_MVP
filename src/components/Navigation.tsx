        ...
        {isAuthenticated ? (
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <button
              ...
              className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg hover:from-purple-700 hover:to-indigo-700 transition-all duration-200 text-sm sm:text-base"
            >
              Get Started
            </button>
          </div>

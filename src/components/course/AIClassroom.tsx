...
export const AIClassroom: React.FC<AIClassroomProps> = ({ course, lesson, isOpen, onClose }) => {
  ...
  const getSubjectIntroduction = (category: string, lessonTitle: string) => {
    const subjectIntroductions: Record<string, string> = {
      'Mathematics': `Welcome to today's mathematics lesson on ${lessonTitle}. I'm Professor YUGA, your AI mathematics instructor. Mathematics is the language of patterns and relationships, and today we'll explore how these concepts apply to real-world problem solving.`,
      'Science': `Welcome to today's science lesson on ${lessonTitle}. I'm Professor YUGA, your AI science instructor. Science helps us understand the natural world through observation and experimentation, and today we'll discover how these principles work in practice.`,
      'Social Studies': `Welcome to today's social studies lesson on ${lessonTitle}. I'm Professor YUGA, your AI social studies instructor. Social studies helps us understand human societies and our place in the world, and today we'll explore important historical and cultural concepts.`,
      ...
      'English': `Welcome to today's English lesson on ${lessonTitle}. I'm Professor YUGA, your AI English instructor. Language is the foundation of communication and expression, and today we'll explore how to use English effectively in various contexts.`,
      'Physics': `Welcome to today's physics lesson on ${lessonTitle}. I'm Professor YUGA, your AI physics instructor. Physics helps us understand the fundamental laws that govern our universe, and today we'll explore how these principles shape our world.`,
      'Chemistry': `Welcome to today's chemistry lesson on ${lessonTitle}. I'm Professor YUGA, your AI chemistry instructor. Chemistry is the science of matter and its transformations, and today we'll discover how these processes work at the molecular level.`,
      'Biology': `Welcome to today's biology lesson on ${lessonTitle}. I'm Professor YUGA, your AI biology instructor. Biology is the study of life in all its forms, and today we'll explore the fascinating processes that sustain living organisms.`,
      'History': `Welcome to today's history lesson on ${lessonTitle}. I'm Professor YUGA, your AI history instructor. History helps us understand our past to make sense of our present, and today we'll examine important events that have shaped our world.`,
      'Geography': `Welcome to today's geography lesson on ${lessonTitle}. I'm Professor YUGA, your AI geography instructor. Geography helps us understand the relationship between people and their environments, and today we'll explore how physical and human systems interact.`,
      'Economics': `Welcome to today's economics lesson on ${lessonTitle}. I'm Professor YUGA, your AI economics instructor. Economics is the study of how societies allocate scarce resources, and today we'll examine fundamental economic principles and their applications.`,
      'Computer Science': `Welcome to today's computer science lesson on ${lessonTitle}. I'm Professor YUGA, your AI computer science instructor. Computer science is the study of computational systems and algorithms, and today we'll explore how these concepts power modern technology.`
    };
